...
public class Main {
    public static void main(String[] args) {
        List<File> fileList = Arrays.asList(new File("D://Game/savegames/save0.dat"),
                new File("D://Game/savegames/save1.dat"),
                new File("D://Game/savegames/save2.dat"));
    ...
    public static void saveGame(GameProgress[] newList) {
        for (int i = 0; i < newList.length; i++) {
            try (FileOutputStream fos = new FileOutputStream("D://Game/savegames/save" + i + ".dat");
    ...
    public static void zipFiles(GameProgress[] newList) {
        try (ZipOutputStream zout = new ZipOutputStream(new
                FileOutputStream("D://Game/savegames/zip_output.zip"))) {
            for (int i = 0; i < newList.length; i++) {
                FileInputStream fis = new FileInputStream("D://Game/savegames/save" + i + ".dat");
